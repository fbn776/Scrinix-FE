...
import {TEditOpen} from "@/components/admin-tabs/EditCollegeTab";
import apiInstance from "@/lib/api";
import {useNotifications} from "@toolpad/core";

export default function EditFacultyDialog({editOpen, handleClose, onUpdate}: {
    editOpen: TEditOpen,
    handleClose: () => void,
    ...
    return (
        ...
        >
            ...
            <DialogContent>
                <DialogContentText>
                    Change the faculty details (<b>{editOpen.id}</b>)
                </DialogContentText>
                <TextField
                    autoFocus
                    margin="dense"
